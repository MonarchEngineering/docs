...
<Steps>
  <Step title="Open connection settings">
    ...
    <Frame>
      <img src="/images/connections/n8n-open-connect-settings.gif" alt="Open connection settings for n8n" />
    </Frame>
  </Step>
  ...
  <Step title="Add the Airtop node">
    ...
    <Frame>
      <img src="/images/connections/n8n-add-airtop-node.gif" alt="Add Run Agent node in n8n" />
    </Frame>
  </Step>
  ...
  <Step title="Set Agent parameters">
    ...
    <Frame>
      <img src="/images/connections/n8n-node-config.png" alt="n8n node configuration" />
    </Frame>
  </Step>
