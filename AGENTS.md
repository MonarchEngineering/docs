...
This is a Mintlify-based documentation site for Airtop. The project structure follows Mintlify conventions with MDX files for content and a `docs.json` configuration file.
...
│   ├── airtable.mdx
│   ├── github.mdx
│   ├── google-*.mdx       # Google services integrations
│   ├── hubspot.mdx
│   ├── slack.mdx
│   ├── linkedin.mdx
│   ├── web-search.mdx
...
# Rename files (updates all references)
mint rename old-file.mdx new-file.mdx
```
